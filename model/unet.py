...
class Unet(nn.Module):
    def __init__(self, model_config):
        ...
        self.num_classes = model_config.get('num_classes', 10)  # 默认10个类别(0-9)
        ...
        # 添加类别嵌入层
        self.class_emb = nn.Embedding(self.num_classes, self.time_emb_dim)
    ...
    def forward(self, x, t, c=None): # x:[b, c, h, w], t:[b], c:[b]
        ...
        if c is not None:
            ...
            t_emb = t_emb + c_emb  # 将时间嵌入和类别嵌入相加
